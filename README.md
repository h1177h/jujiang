...
- 创新点：场景级工作台编辑、角色关系摘要、场景冲突强度、原文追溯、改编风格选择、节奏统计、改编计划、故事诊断、作者审稿台。
...
7. 查看页面底部作者审稿台：改编计划、故事诊断、角色关系、节奏指标和分场卡片。
8. 选中一个场景，在场景编辑器里修改目标、地点、对白或冲突等级，确认右侧 YAML 和校验状态同步更新。
9. 点击复制或下载 YAML。
10. 对照 [YAML Schema 文档](docs/yaml-schema.md) 解释字段设计。
11. 展示 [参考项目分析](docs/reference-analysis.md) 中的独立改写说明。
