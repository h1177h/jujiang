...
- 创新点：长篇逐章事件抽取、故事圣经合并、Schema 修复回合、单场 AI 补强、轻量版本历史、章节事件图谱、场景级工作台编辑、章节到场景映射、冲突曲线、质量检查、角色关系摘要、原文追溯、改编风格选择、节奏统计、改编计划。
...
11. 点击保存、恢复版本、复制或下载 YAML。
12. 对照 [YAML Schema 文档](docs/yaml-schema.md) 解释字段设计。
13. 展示 [参考项目分析](docs/reference-analysis.md) 中的独立改写说明。
