...
13. 保存和恢复一个版本，再点击复制或下载 YAML。
14. 对照 `docs/yaml-schema.md` 讲字段设计。
15. 对照 `docs/reference-analysis.md` 讲参考项目借鉴和独立改写。
...
- 可操作创新点：长篇逐章事件抽取、故事圣经合并、Schema 修复回合、单场 AI 补强、轻量版本历史、章节事件图谱、场景级工作台编辑、章节到场景映射、冲突曲线、质量检查、角色关系摘要、原文追溯、改编风格选择、节奏统计。
