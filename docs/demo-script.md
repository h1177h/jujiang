...
然后向下滚动到作者审稿台，展示同一份 YAML 被解析成改编计划、故事诊断、角色关系、节奏指标和分场卡片。
...
展示右侧 YAML 已同步变化，节奏统计和高冲突场景也会跟着更新。
...
- 作品完整度与创新性：三章输入、自动转换、多场景拆分、可编辑 YAML、实时校验、复制下载、角色关系、冲突强度、原文追溯、风格选择、改编计划、故事诊断、作者审稿台。
